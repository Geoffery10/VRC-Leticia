Shader "Custom/Object Shaders/RimLight Fade"
{
	Properties
	{
	
			[Header(___RimLight___)]
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb35 = HSVToRGB( half3(mulTime31,_Saturation,_Value) );
			float2 uv_RimlightTexture = i.uv_texcoord * _RimlightTexture_ST.xy + _RimlightTexture_ST.zw;
			half4 blendOpSrc29 = half4( hsvTorgb35 , 0.0 );
			half4 blendOpDest29 = tex2D( _RimlightTexture, uv_RimlightTexture );
			o.Emission = ( pow( ( 1.0 - saturate( dotResult21 ) ) , _RimPower ) * ( saturate( (( blendOpDest29 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest29 - 0.5 ) ) * ( 1.0 - blendOpSrc29 ) ) : ( 2.0 * blendOpDest29 * blendOpSrc29 ) ) )) );
			o.Alpha = 1;
		}
