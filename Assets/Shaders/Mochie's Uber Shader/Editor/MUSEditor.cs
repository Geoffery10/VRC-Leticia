            ...
            if (isToon){
                ...
                if (showShading){
                    ...
                    if (_FakeSpec.floatValue == 1){
                        materialEditor.ShaderProperty(_SpecCol, "Color", 2);
                        materialEditor.ShaderProperty(_SpecBias, "Bias", 2);
                        materialEditor.ShaderProperty(_SpecStr, "Strength", 2);
                        materialEditor.ShaderProperty(_SpecSize, "Smoothness", 2);
                        GUILayout.Space(8);
                    }
                    ...
                    if (_Subsurface.floatValue == 1){
                        ...
                        materialEditor.ShaderProperty(_SColor, "Color", 2);
                        materialEditor.ShaderProperty(_SStrength, "Strength", 2);
                        materialEditor.ShaderProperty(_SPen, "Penetration", 2);
                        materialEditor.ShaderProperty(_SSharp, "Sharpness", 2);
                    }
                    GUILayout.Space(8);
